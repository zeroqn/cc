...
use cc::threshold::{PrivateKeySet, PublicKeySet, ThresholdCrypto};
...
#[cfg(feature = "generate")]
impl cc::KeyGenerator for BLS12381PrivateKeyShare {
...
#[cfg(feature = "generate")]
impl cc::threshold::KeySetGenerator for BLS12381PrivateKeySet {
...
mod tests {
    ...
    use cc::threshold::{PrivateKeySet, PublicKeySet};
